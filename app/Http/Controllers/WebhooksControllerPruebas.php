        ...
        switch ($response->status) {
            case 'approved':
                ...
                if ($materialesComprados) {
                    ...
                    $notificacion = new PaymentApprovedEmail($order->id, $order->user->name, $order->amount . "prueba");
                ...
                foreach ($membreships as $membresia) {
                    ...
                    if ($membresia->membership_id == 2006) {
                        ...
                        $correoCopia = new MembresiaPreescolar($order->id, $order->user->name, $order->user->email, $membresia->price . "prueba");
                    ...
                    if ($membresia->membership_id  == 2007) {
                        ...
                        $correoCopia = new MembresiaPrimaria($order->id, $order->user->name, $order->user->email, $membresia->price . "prueba");
                        Mail::to('arnulfoacosta0887@gmail.com')
                            ->send($correoCopia);
                    }
                }
